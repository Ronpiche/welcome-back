const { ERROR, WARNING, OFF, MAX_NESTED_CALLBACK, MAX_PARAMS, ESLINT_IGNORES, READONLY } = require("../eslint.constants");
...
const ESLINT_GLOBAL_CONFIG = Object.freeze({
  ...
  rules: {
    ...
    "camelcase": [WARNING, { allow: ["npm_package_version"] }],
    ...
    "no-empty": ERROR,
    "no-empty-function": [WARNING, { allow: ["constructors"] }],
