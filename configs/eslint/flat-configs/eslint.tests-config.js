...
const { OFF, ERROR, WARNING } = require("../eslint.constants");
...
const ESLINT_TESTS_CONFIG = Object.freeze({
  ...
  rules: {
    ...
    "jest/no-conditional-expect": WARNING,
    ...
    "jest/require-to-throw-message": WARNING,
    "jest/require-top-level-describe": ERROR,
    "jest/valid-describe-callback": ERROR,
    "jest/valid-expect": ERROR,
    "jest/valid-expect-in-promise": ERROR,
    "jest/valid-title": [WARNING, { mustMatch: { it: new RegExp(/^should .+ when .+\S\.$|^\$test$/u, "u").source } }],
