  ...
  login(options: any = {}) {
    return async (req, res, next) => {
      ...
      const csrfToken = this.jwtService.sign(
        { id: Date.now(), token: this.cryptoProvider.createNewGuid() },
        { expiresIn: 40, algorithm: 'RS256' },
      );
      ...
      return this.redirectToAuthCodeUrl(authCodeUrlRequestParams, authCodeRequestParams)(req, res, next);
    };
  }
