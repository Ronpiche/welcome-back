...
export class ContentController {
  ...
  async create(@Body() createContentDto: CreateContentDto): Promise<FirestoreDocumentType> {
  ...
  @ApiOkResponse({ type: ContentEntity })
  async findOne(@Param("id") id: string): Promise<FirestoreDocumentType> {
  ...
  @ApiBody({ schema: { example: { "on-boarding": {} } } })
  @ApiOkResponse({ type: ContentEntity })
  async update(@Param("id") id: string, @Body() updateContentDto: UpdateContentDto): Promise<FirestoreDocumentType> {
